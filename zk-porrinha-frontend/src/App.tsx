...
import { ZkPorrinhaGame } from './games/zk-porrinha/ZkPorrinhaGame';

const GAME_ID = 'zk-porrinha';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Zk Porrinha';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_ZK_PORRINHA_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
